 ...
 *
 */
if ( ! class_exists( 'AGSHOPGLUT_Abstract' ) ) {
  abstract class AGSHOPGLUT_Abstract {
      ...
      if ( ! empty( $fields ) ) {
        ...
        foreach ( $fields as $field ) {
          ...
          if ( $field_type && $field_id ) {
            ...
            AGSHOPGLUT::maybe_include_field( $field_type );

            $class_name = 'AGSHOPGLUT_' . $field_type;
            ...
            if ( class_exists( $class_name ) ) {
              ...
              if ( method_exists( $class_name, 'output' ) || method_exists( $class_name, 'enqueue_google_fonts' ) ) {
                ...
                if ( $field_output && $this->args['output_css'] ) {
                  AGSHOPGLUT::$css .= $instance->output();
                }
