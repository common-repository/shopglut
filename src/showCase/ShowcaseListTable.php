...
class ShowcaseListTable extends \WP_List_Table
{
    ...
    public function column_layout_name($item)
    {
        ...
        $edit_link   = add_query_arg(['layout_id' => $layout_id], admin_url('admin.php?page=shopglut_showcase'));
    ...
    function prepare_items()
    {
        ...
        /* pagination */
        $per_page = $this->get_items_per_page('shopglut_showcase_per_page', 10);
