...
class AddNewLayout {
	...
	public function __construct() {
		if (isset($_GET['page']) && trim($_GET['page']) === 'shopglut_layouts') {
			// phpcs:ignore
...
<div id="shopg_layout_modal" class="shopg_layout_modal">
    ...
    <div class="modal-content">
		...
		$design_folder = SHOPGLUT_PATH . '/src/layouts/templates';
			...
			if ($design_files && is_array($design_files)) {
				...
				foreach ($design_files as $design_path) {
					...
					while ($query->have_posts()) {
						...
						$template_class = 'Shopglut\\layouts\\templates\\' . $file_name;
...
// Handle form submission
	...
	public function handleCreateLayout() {
		...
		if (
			...
			$redirect_url = admin_url('admin.php?page=shopglut_layouts&layout_id=' . $layout_id);
