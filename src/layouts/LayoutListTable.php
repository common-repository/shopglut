...
class LayoutListTable extends \WP_List_Table {
	...
	public function no_items() {
		esc_html__('No layout found.', 'shopglut');
	}
	...
	public function column_layout_name($item) {
		...
		$edit_link = add_query_arg(['route' => 'shop_layout', 'layout_id' => $layout_id], admin_url('admin.php?page=shopglut_layouts'));
		...
		$a = '<a href="' . esc_url($edit_link) . '">' . esc_html($item['title']) . '</a>';
